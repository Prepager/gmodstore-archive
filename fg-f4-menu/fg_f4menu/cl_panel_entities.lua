...
function PANEL:FillData()
	...
	for k, v in ipairs( DarkRPEntities ) do
		...
		object.Paint = function( pnl, w, h )
			...
			draw.DrawText( "Max: " .. objectMax, "FG_JaapokkiRegular_24", 135 + ( object:GetWide() - 155 ) / 2, 35 + 40, Color( 100, 100, 100, 255 ), 1 )
...
--[[---------------------------------------------------------
	Name: Define
-----------------------------------------------------------]]
derma.DefineControl( "FG-F4Menu-Entities", "FG-F4Menu-Entities", PANEL, "FG-DScrollPanel" )