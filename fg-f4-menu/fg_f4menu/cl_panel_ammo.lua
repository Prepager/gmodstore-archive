...
function PANEL:FillData()
	...
	for k, v in pairs( GAMEMODE.AmmoTypes ) do
		...
		--> Checks
		local CanGet, Important = CanUseItem( v )
		...
		local objectAmount	= v.amountGiven 	or 0
		...
		object.Paint = function( pnl, w, h )
			...
			draw.DrawText( "Bullets: " .. objectAmount, "FG_JaapokkiRegular_24", 135 + ( object:GetWide() - 155 ) / 2, 35 + 40, Color( 100, 100, 100, 255 ), 1 )
...
--[[---------------------------------------------------------
	Name: Define
-----------------------------------------------------------]]
derma.DefineControl( "FG-F4Menu-Ammo", "FG-F4Menu-Ammo", PANEL, "FG-DScrollPanel" )