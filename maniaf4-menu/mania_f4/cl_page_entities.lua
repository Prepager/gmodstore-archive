...
function PANEL:Init()
	...
	--> Categories
	self:SetCategories(DarkRP.getCategories().entities)
...
--[[---------------------------------------------------------
	Define: ManiaPage-entities
-----------------------------------------------------------]]
derma.DefineControl('ManiaPage-entities', 'ManiaPage-entities', PANEL, 'ManiaPage-base')